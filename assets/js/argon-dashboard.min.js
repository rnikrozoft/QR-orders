...
function sidebarColor(e) {
    ...
    e.classList.contains("active") ? e.classList.remove("active") : e.classList.add("active"), document.querySelector(".sidenav").setAttribute("data-color", s), document.querySelector("#sidenavCard") && (e = ["btn", "btn-sm", "w-100", "mb-0", "bg-gradient-" + s], (s = document.querySelector("#sidenavCard .btn")).className = "", s.classList.add(...e))
}
...
function sidebarType(e) {
    ...
    if (d.classList.add(s), "bg-white" == s) { var u = document.querySelectorAll(".sidenav .text-white"); for (let e = 0; e < u.length; e++) u[e].classList.remove("text-white"), u[e].classList.add("text-dark") } else { var v = document.querySelectorAll(".sidenav .text-dark"); for (let e = 0; e < v.length; e++) v[e].classList.add("text-white"), v[e].classList.remove("text-dark") }
    if ("bg-default" == s && a) { v = document.querySelectorAll(".navbar-brand .text-dark"); for (let e = 0; e < v.length; e++) v[e].classList.add("text-white"), v[e].classList.remove("text-dark") }
...
function toggleNavLinksColor(e) {
    ...
    "blur" === e ? (t.forEach(e => { e.classList.remove("text-white") }), s.forEach(e => { e.classList.add("bg-dark"), e.classList.remove("bg-white") })) : "transparent" === e && (t.forEach(e => { e.classList.add("text-white") }), s.forEach(e => { e.classList.remove("bg-dark"), e.classList.add("bg-white") }))
}
...
function navbarBlurOnScroll(e) {
    ...
    } : function() { l() }, 10), -1 < navigator.platform.indexOf("Win") && (s = document.querySelector(".main-content"), "true" == e ? s.addEventListener("ps-scroll-y", debounce(function() {
        (5 < s.scrollTop ? i : l)()
    }, 10)) : s.addEventListener("ps-scroll-y", debounce(function() { l() }, 10)))
}
...
html.addEventListener("click", function(e) { body.classList.contains("g-sidenav-pinned") && !e.target.classList.contains("sidenav-toggler-line") && body.classList.remove(className) });
