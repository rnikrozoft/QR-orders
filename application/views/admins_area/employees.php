                                    ...
                                    <tbody>
                                        <?php foreach ($data as $r) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <param><?php echo $r->fname; ?></p>
                                                </td>
                                                <td>
                                                    <p><?php echo $r->lname; ?></p>
                                                </td>
                                                <td>
                                                    <p><?php echo $r->nname; ?></p>
                                                </td>
                                                <td>
                                                    <p><?php echo $r->age; ?></p>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="row g-3">
                                                        <div class="col-auto d-grid">
                                                            <button type="button" class="btn btn-primary btn-sm mb-3 getone" data-bs-toggle='modal' data-bs-target='#em-m'>Edit</button>
                                                        </div>
                                                        <div class="col-auto d-grid">
                                                            <a class="btn btn-primary btn-sm mb-3" onclick="return confirm('ยืนยันการลบข้อมูลนี้ ?');" href="<?php echo base_url('employees/deleteByID/' . $r->id); ?>">Delete</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
